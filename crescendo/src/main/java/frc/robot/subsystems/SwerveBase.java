  ...
  public SwerveBase() {
    ...
    AutoBuilder.configureHolonomic(
            ...
            new HolonomicPathFollowerConfig( // HolonomicPathFollowerConfig, this should likely live in your Constants class
                    new PIDConstants(9.99, 0.0, 0.885),//4.0 // Translation PID constants   0-9.99  under  0.885 -0.8855  over           new PIDConstants(5.0, 0.0, 0.00005), // Translation PID constants 
                    new PIDConstants(9.99, 0.0, 0.0),//4.0 // Rotation PID constants      0-9.99
